namespace VtNetCore.XTermParser
{
    ...
    public class DataConsumer
    {
        ...
        /// </remarks>
        public void Push(byte[] data, FileStream s)
        {
            // System.Diagnostics.Debug.WriteLine("Resuming from starved buffer [" + Encoding.UTF8.GetString(data).Replace("\u001B", "<esc>") + "]");
            ...
            while (!InputBuffer.AtEnd)
            {
                try
                {
                    ...
                    var sequence = XTermSequenceReader.ConsumeNextSequence(s, Controller.IsUtf8());
